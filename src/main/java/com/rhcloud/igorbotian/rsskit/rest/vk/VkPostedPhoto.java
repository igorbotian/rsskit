...
public class VkPostedPhoto {
    ...
    private static final VkEntityParser<VkPostedPhoto> PARSER = new VkPostedPhotoParser();
    ...
    private static class VkPostedPhotoParser extends VkEntityParser<VkPostedPhoto> {
